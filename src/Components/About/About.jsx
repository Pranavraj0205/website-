  ...
  return (
    <div className='about'>
        ...
        <div className="about-right">
           ...
           <p>
               Weather you aspire to become a teacher, adminstrator, counselor or educational leader, our diverse range of programs offers the perfect pathway to achieve your goals and unlock your full potential in shaping the future of education. 
           </p>
        </div>
    </div>
  )
