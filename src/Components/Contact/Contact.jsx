...
function Contact() {
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "36ac0e46-1eb6-4c02-b055-2dd6e2159334");
      ...
      <div className="contact-col">
           ...
           <ul>
            ...
            <img src={mail_icon} alt="" />
               pranavraj0205@gmail.com
               
            </li>
            <li><img src={phone_icon} alt="" />+1- 123-456-789 </li>
            <li><img src={location_icon} alt="" />77 Masshusets Ave, Cambridge <br />MA 02319, United States </li>
            </ul>
      </div>
      <div className="contact-col">
          <form onSubmit={onSubmit}>
            ...
            <textarea name="mesaage"  row ="6" placeholder='enter your message ' required></textarea>
